...
;layui.define(["laytpl", "layer"], function (e) {
  var t = layui.jquery, n = layui.laytpl, a = layui.layer, r = layui.setter, o = (layui.device(), layui.hint()), i = function (e) {
    return new d(e)
  ...
  i.loading = function (e) {
    ...
    return e = r.views + e + r.engine, t("#" + s).children(".layadmin-loading").remove(), i.loading(a.container), t.ajax({
      ...
      success: function (e) {
        e = "<div>" + e + "</div>";
        var r = t(e).find("title"), o = r.text() || (e.match(/\<title\>([\s\S]*)\<\/title>/) || [])[1], s = {
          title: o,
          body: e
        };
    ...
    for (var p = u.length; p > 0; p--)!function () {
      var e = u.eq(p - 1), t = e.attr("lay-done") || e.attr("lay-then"), a = n(e.attr("lay-url") || "").render(y), r = n(e.attr("lay-data") || "").render(y), s = n(e.attr("lay-headers") || "").render(y);
      try {
